// app/src/main/java/com/example/anchor/server/AnchorServerService.kt
//
...
//
//        /**
//         * Helper to start the server service.
//         */
//        fun startServer(
//            context: Context,
//            port: Int = 8080,
...
//
//        /**
//         * Helper to stop the server service.
//         */
...
//
//    // TODO: Will be initialized in Step 5
...
//
//    /**
//     * Updates the notification with current server status.
//     */
...
//
//    /**
//     * Starts the HTTP server and acquires necessary locks.
//     */
...
//
//                // Acquire wake lock to keep CPU running during transfers
//                acquireWakeLock()
//
...
//                AnchorServiceState.addLog("Server starting on $localIp:$serverPort")
//
//                // TODO: Start the actual HTTP server in Step 5
//                // httpServer = AnchorHttpServer(serverPort, sharedDirectories)
//                // httpServer?.start()
//
//                isServerRunning = true
//                AnchorServiceState.addLog("Server started successfully")
//
//                // Update notification with server URL
...
//
//    /**
//     * Stops the HTTP server and releases all locks.
//     */
...
//
//                // TODO: Stop the HTTP server in Step 5
//                // httpServer?.stop()
//                // httpServer = null
//
...
//
//    /**
//     * Acquires a partial wake lock to keep the CPU running during file transfers.
//     */
...
//
//    /**
//     * Refreshes the wake lock timeout (call periodically during active transfers).
//     */
//    fun refreshWakeLock() {
//        wakeLock?.let {
//            if (it.isHeld) {
//                it.acquire(10 * 60 * 1000L) // Refresh for another 10 minutes
//            }
//        }
//    }
//
