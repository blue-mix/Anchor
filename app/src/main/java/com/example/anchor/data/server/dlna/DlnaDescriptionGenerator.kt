package com.example.anchor.data.server.dlna
...
/**
 * Generates UPnP/DLNA XML description documents served at the /dlna/ endpoints.
 *
 * Renamed from DlnaDescriptionHandler → DlnaDescriptionGenerator to better
 * reflect its role (pure generation, no request handling).
 * Moved to server.dlna package to match the target directory structure.
 * Logic is unchanged from Phase 2.
 */
class DlnaDescriptionGenerator(
...
<friendlyName>Anchor: $deviceName</friendlyName>
<manufacturer>Anchor</manufacturer>
<manufacturerURL>https://github.com/anchor</manufacturerURL>
<modelDescription>Anchor Local Media Server</modelDescription>
<modelName>Anchor Media Server</modelName>
<modelNumber>1.0</modelNumber>
<serialNumber>${deviceUuid.take(8)}</serialNumber>
<UDN>uuid:$deviceUuid</UDN>
<dlna:X_DLNADOC xmlns:dlna="urn:schemas-dlna-org:device-1-0">DMS-1.50</dlna:X_DLNADOC>
<presentationURL>http://$ip:$serverPort/</presentationURL>
<iconList>
<icon>
...
// ── ContentDirectory service description ──────────────────
    ...
    fun getContentDirectoryDescription(): String = """<?xml version="1.0" encoding="UTF-8"?>
...
// ── ConnectionManager service description ─────────────────
    ...
    fun getConnectionManagerDescription(): String = """<?xml version="1.0" encoding="UTF-8"?>
<scpd xmlns="urn:schemas-upnp-org:service-1-0">
<specVersion><major>1</major><minor>0</minor></specVersion>
<actionList>
<action>
...
// ── Protocol info ─────────────────────────────────────────
    ...
    fun getProtocolInfo(): String = listOf(
        "http-get:*:video/mp4:*",
